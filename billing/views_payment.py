...
@swagger_auto_schema(
    method="post",
    operation_description="Initiate payment with ZenoPay for an SMS package.",
    request_body=openapi.Schema(
        type=openapi.TYPE_OBJECT,
        required=["package_id", "buyer_email", "buyer_name", "buyer_phone"],
        properties={
            "package_id": openapi.Schema(type=openapi.TYPE_STRING, format=openapi.FORMAT_UUID),
            "buyer_email": openapi.Schema(type=openapi.TYPE_STRING, format=openapi.FORMAT_EMAIL),
            "buyer_name": openapi.Schema(type=openapi.TYPE_STRING),
            "buyer_phone": openapi.Schema(type=openapi.TYPE_STRING),
        },
    ),
