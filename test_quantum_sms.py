...
This will send a real SMS using the active "Quantum" sender ID
"""
import requests
import base64
import json
...
def test_quantum_sms():
    """Test sending SMS with Quantum sender ID"""
    
    print("=" * 60)
    print("  QUANTUM SENDER ID SMS TEST")
    print("=" * 60)
    ...
    # SMS data with Quantum sender ID
    message = "QUANTUM SMS TEST: This is a real SMS message sent via Mifumo SMS API using Quantum sender ID to +255757347863. If you receive this, the SMS service is working perfectly!"
    phone_number = "+255757347863"
    sender_id = "Quantum"  # Use the active sender ID
    ...
    print()
    print("=" * 60)
    print("  QUANTUM SMS TEST SUMMARY")
    print("=" * 60)
    ...
    print("OK The 'Quantum' sender ID is active and working!")
    print()
